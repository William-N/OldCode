...
//    	ProblemSet_wfnichol_0057
        ...
        /* Test your code here to verify it is correct before submitting */
    		...
    		//Code for question 3, EDIT
    		//System.out.println(getAndSort(934));
		...
		TestingGrounds57 test = new TestingGrounds57();
		XYPoint point1 = test.new XYPoint(3.24, -7.9);
		XYPoint point2 = test.new XYPoint(-6.93, -1.79);
