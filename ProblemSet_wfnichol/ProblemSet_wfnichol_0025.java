...
public class ProblemSet_wfnichol_0025
{
    
    
    /**
     * Note: This problem set you will use inner classes by defining custom classes inside the 
     * ProblemSet_wfnichol_0025 class. This is only done so you can submit multiple classes a 
    ...
    public class Trail
    {
    		...
    		public double whereTheFlowerBlooms()
    		{
